...
<head>
    ...
    <style>
        ...
        .paidan input[type="radio"]::before {
            content: "";
            position: absolute;
            top: 0;
            left: 0;
        ...
        .paidan input[type="radio"]:checked::before {
            content: "\2713";
            border-radius: 20px;
            background-color: #fff;
            position: absolute;
...
<div class="content">
    ...
    <div class="container-padding">
        <div class="row">
            <form action="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_add.html" class="form-horizontal" method="post"
                  id="dx_form" autocomplete="off" enctype="multipart/form-data">
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" style="padding-top:7px;">
                                    ...
                                    <input type="radio" name="worktype" value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?>
                                    style="margin:0px;height:15px;" ><?php echo $v; }?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" data-toggle="tooltip"
                                     title="每个买家号通过日积月累的消费习惯和浏览习惯产生的高权重类目标签，此标签是淘宝系统分配的，我们的号通过查号接口已经得到用户权重类目并且已经分配好。">
                                ...
                                <div class="col-sm-3" data-toggle="tooltip"
                                     title="标签词：一个产品的标示代表产品的身份的词句。它有时会是产品的品牌名，产品的成分，或者产品的独特个性！">
                                    <input type="text" class="form-control" name="tags" value="" placeholder="必填">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label form-label"><b>*</b>商品标题</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="goodstitle" value=""
                                           placeholder="商品在淘宝全标题">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label form-label"><b>*</b>商品链接</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="goodsurl" value=""
                                           placeholder="需要补单商品链接，以http://或者https://开头">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label form-label"><b>*</b>商品主图</label>
                                <div class="col-sm-8">
                                    <input type="file" id="dx_file" name="dx_file" onchange="sc('mainimage');"
                                           style="display:none"/>
                            ...
                            <div class="form-group">
                                ...
                                <div style="width:25px;float:left;padding-left:15px;">
                                    <input type="radio"  style="margin-top:0px;" name="isattr"
                                           checked value="2">
                                </div>
                                ...
                                <div class="col-sm-2" style="padding-left:8px;">
                                    <input type="text" class="form-control" name="attrcolor" disabled value=""
                                           placeholder="填写颜色类型">
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="attrsize" disabled value=""
                                           placeholder="填写尺码大小">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" style="padding-top:7px;">
                                    <p>
                                        ...
                                        <input type="radio" name="ishuabei"
                                               value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?>
                                        style="margin:0px;height:15px;"><?php echo $v; }?>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        是否允许用户信用卡付款：
                                        <?php foreach($enum_iscredit_arr as $k=>$v){?>
                                        <input type="radio" name="iscredit"
                                               value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?>
                                        style="margin:0px;height:15px;"><?php echo $v; }?>
                                    </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="present" value=""
                                           placeholder="建议赠送抽纸或卷纸">
                                </div>
                                <div class="col-sm-5" style="padding-top:7px;color:red;">
                                    （提示：禁止赠送有争议的产品，比如易碎、易破、产品质量超级垃圾等。）
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <p>
                                        ...
                                        <input type="radio" name="istime"
                                               value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?>><?php echo $v; }?>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group paidan" >
                                ...
                                <div class="col-sm-8">
                                    <p>
                                        ...
                                        <input type="radio" name="istag"
                                               value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?>><?php echo $v; }?>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group" id="istag" style="display: none">
                                    <label class="col-sm-2 control-label form-label">竞品宝贝关键词</label>
                                    <div class="col-sm-1">
                                        <input type="text" name="tagkeyworks" value="" />
                                    </div>
                                    <label class="col-sm-2 control-label form-label">竞品宝贝链接</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="tagurl" value="" placeholder="" />
                                    </div>

                            </div>
                            <div class="taskdetail" id="detail">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label form-label"><span
                                            style="font-size: 16px;padding-right: 10px;" id="bianhao">1.</span><b>*</b>搜索关键词</label>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-1" data-toggle="tooltip" title="备注：下单时需要注意的事项（比如领取优惠券等）">
                                        <input type="text" class="form-control" name="priceremark[]" value=""
                                               placeholder="备注">
                                    </div>
                                ...
                                <div id="istime" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="text" name="time11[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">12点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time12[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">13点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time13[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="text" name="time14[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">15点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time15[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">16点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time16[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="text" name="time17[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">18点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time18[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">19点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time19[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="text" name="time20[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                        <label class="col-sm-2 control-label form-label">21点订单数</label>
                                        <div class="col-sm-1">
                                            <input type="text" name="time21[]" value="0" placeholder="不超过单数"
                                                   rel="istimenum">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="remark[]" value=""
                                               placeholder="备注">
                                        <div class="col-sm-9" id="keytishi" style="padding-top:7px;color:red;display:none">提示：选择人工设置时间，必须每个关键词单数都要设置时间点，要不然会影响任务进行！！！</div>
                                    </div>

                                    <div class="col-sm-1">
                                        <button type="button" class="btn btn-danger" rel="del" style="display:none;">
                                            删除
                                        </button>
                                    </div>
                                </div>
    ...
    $("#addKeywords").on('click', function () {
        ...
        if (istime == 2) {
            keywordsarr = ' <div class="taskdetail" id="detail">' +
                    ...
                    '<label class="col-sm-2 control-label form-label">8点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time8[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">9点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time9[]" value="0" placeholder="" rel="istimenum">' +
                    '</div >' +
                    '<label class="col-sm-2 control-label form-label">10点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time10[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group"  >' +
                    '<label class="col-sm-2 control-label form-label">11点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time11[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">12点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time12[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">13点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time13[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group"  >' +
                    '<label class="col-sm-2 control-label form-label">14点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time14[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">15点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time15[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">16点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time16[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group"  >' +
                    '<label class="col-sm-2 control-label form-label">17点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time17[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">18点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time18[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">19点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time19[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group"  >' +
                    '<label class="col-sm-2 control-label form-label">20点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time20[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '<label class="col-sm-2 control-label form-label">21点订单数</label>' +
                    '<div class="col-sm-1">' +
                    '<input type="text" name="time21[]" value="0" placeholder="" rel="istimenum">' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
