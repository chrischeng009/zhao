<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/merchant/view/order/export.html";i:1586928866;}*/ ?>
...
<table border="1">
    <tr>
        ...
        <td style="font-weight:bold;">服务费</td>
    ...
    <tr>
        ...
        <td style="text-align:center;"><?php echo $v['without_price']; ?></td>
        ...
        <!--<td style="text-align:left;"><?php echo $status1_name; ?></td>-->
