<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/view/adminbank/lists.html";i:1586928885;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1586928883;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1586928883;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1586928883;s:61:"/www/wwwroot/nouser/application/admin/view/adminbank/add.html";i:1586928885;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/edit.html?id=<?php echo $v['id']; ?>"><span class="label label-success">编辑</span></a>
            ...
            <div class="col-md-12">
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">收款人姓名</label>
                            <div class="col-sm-8">
