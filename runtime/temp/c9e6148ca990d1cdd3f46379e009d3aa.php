          ...
          <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="form-group">              
                            <select class="form-control" name="tbgrade">
                                ...
                                <option value="<?php echo $k; ?>" <?php if($k==$_GET['tbgrade']){ echo 'selected';}?>><?php echo $v; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="form-group">              
                            <select class="form-control" name="province">
                                ...
                                <option value="<?php echo $v['id']; ?>" <?php if($v['id']==$_GET['province']){ echo 'selected';}?>><?php echo $v['name']; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-1">
                        ...
                        <div class="form-group">              
                            <select class="form-control" name="sex">
                                ...
                                <option value="<?php echo $k; ?>" <?php if($k==$_GET['sex']){ echo 'selected';}?>><?php echo $v; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-1">
                        <h5>做单间隔(天)</h5>
                        <div class="form-group">              
                            <input type="text" class="form-control" name="orderday" value="<?php echo $_GET['orderday']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-1">
                        <h5>搜索</h5>
          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $tbgrade_name; ?></td>
                    <td><?php echo $v['taoqi']; ?></td>
                    <td><?php echo $v['birthyear']; ?>年</td>
                    <td><?php echo $sex_name; ?></td>
                    <td><?php echo $find_area['name']; ?></td>
                    <td><?php echo $v['money']; ?></td>
                    <td><?php echo $v['freeze_money']; ?></td>
                    <td>
                        <a href="javascript:;" onclick="javascript:ordershopname(<?php echo $v['id']; ?>);"><span class="label label-warning">查看</span></a>
                    </td>
                    <td>
                        <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/edit.html?id=<?php echo $v['id']; ?>"><span class="label label-primary">编辑</span></a>
                        <a href="/home.php/<?php echo $module; ?>/order/lists.html?user_id=<?php echo $v['id']; ?>&abc=1"><span class="label label-info">订单</span></a>
                        <a href="/home.php/<?php echo $module; ?>/usermlogs/lists.html?user_id=<?php echo $v['id']; ?>&abc=1"><span class="label label-danger">财务</span></a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
...
<script type="text/javascript">
    function ordershopname(id){
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_ordershopname.html',
            dataType:'text',
            data:"id="+id,
