                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="form-group">              
                            <input type="text" class="form-control" name="merchant_id" value="<?php echo $_GET['merchant_id']; ?>">
                        </div>
                    </div>
                    <?php }?>
                    <div class="col-lg-2">
