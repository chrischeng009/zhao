                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="category_id">
                                    ...
                                    ?>
                                    <option value="<?php echo $v['id']; ?>" <?php if($v['id']==$find['category_id']){ echo 'selected';}?>><?php echo $v['name']; ?></option>
                                    <?php if($child){ foreach($child as $vv){ ?>
                                    <option value="<?php echo $vv['id']; ?>" <?php if($vv['id']==$find['category_id']){ echo 'selected';}?>>|______<?php echo $vv['name']; ?></option>
                                    <?php } }}?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="flag">
                                    ...
                                    <option value="<?php echo $k; ?>" <?php if($k==$find['flag']){ echo 'selected';}?>><?php echo $v; ?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="<?php echo $find['img']; ?>" id="imgView" style="height:100px;">
                                <input type="hidden" name="img" value="<?php echo $find['img']; ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" style="height:600px;" id="content" name="content"><?php echo $find['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">作者</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="author" value="<?php echo $find['author']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">排序</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sort" value="<?php echo $find['sort']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
