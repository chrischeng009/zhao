<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./application/admin/view/menu/lists.html";i:1586928882;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1586928883;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1586928883;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1586928883;s:57:"/www/wwwroot/nouser/application/admin/view/menu/edit.html";i:1586928882;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                <?php
                foreach($lists as $v){
                $isshow_name = MenuModel::enum_isshow_text($v['isshow']);
                $child = MenuModel::select("and pid=".$v['id']);
                ?>
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    <td><?php echo $v['name']; ?></td>
                    <td><?php echo $isshow_name; ?></td>
                    <td><?php echo $v['sort']; ?></td>
                    <td>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $v['id']; ?>);"><span class="label label-primary">编辑</span></a>
                        <a href="javascript:;" onclick="javascript:add(<?php echo $v['id']; ?>);"><span class="label label-success">添加子级</span></a>
                    </td>
                </tr>
                
                <?php if($child){ foreach($child as $vv){ $isshow_name = MenuModel::enum_isshow_text($vv['isshow']); ?>
                <tr data-id="<?php echo $vv['id']; ?>">
                    <td><?php echo $vv['id']; ?></td>
                    <td>|______<?php echo $vv['name']; ?>-<?php echo $vv['control']; ?>-<?php echo $vv['action']; ?></td>
                    <td><?php echo $isshow_name; ?></td>
                    <td><?php echo $vv['sort']; ?></td>
                    <td>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $vv['id']; ?>);"><span class="label label-primary">编辑</span></a>
