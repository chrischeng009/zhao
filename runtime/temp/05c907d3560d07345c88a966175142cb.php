                        ...
                        <div class="col-lg-1">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="status">
                                    <option value="">请选择 </option>
                                    <?php foreach($enum_status_arr as $k=>$v){if($k== 2 || $k==4){?>
          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="javascript:;" onclick="javascript:imger('<?php echo urlencode($v['zfbimg']);?>');"><img src="<?php echo $v['zfbimg']; ?>" style="height:30px;"/></a></td>
                    <td><?php echo $v['taoqi']; ?></td>
                    <td><a href="javascript:;" onclick="javascript:imger('<?php echo urlencode($v['taoqiimg']);?>');"><img src="<?php echo $v['taoqiimg']; ?>" style="height:30px;"/></a></td>
                    <td><?php echo $sex_name; ?></td>
                    <td><?php echo $tbgrade_name; ?></td>
                    <td><?php echo $status_name; ?></td>
                    <td>
                        <a href="javascript:;" onclick="javascript:edit_tbgrade(<?php echo $v['id']; ?>,<?php echo $v['status']; ?>);"><span class="label label-warning">等级</span></a>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $v['id']; ?>,3);"><span class="label label-success">同意</span></a>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $v['id']; ?>,4);"><span class="label label-danger">拒绝</span></a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
