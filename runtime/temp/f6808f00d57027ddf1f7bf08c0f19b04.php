                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="type">
                                    ...
                                    <option value="<?php echo $k; ?>" <?php if($k==$find['type']){ echo 'selected';}?>><?php echo $v; ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="status">
                                    ...
                                    <option value="<?php echo $k; ?>" <?php if($k==$find['status']){ echo 'selected';}?>><?php echo $v; ?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="aid">
                                    ...
                                    <option value="<?php echo $v['id']; ?>" <?php if($v['id']==$find['aid']){ echo 'selected';}?>><?php echo $v['name']; ?></option>
                                    <?php }?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="address" value="<?php echo $find['address']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <img src="<?php echo $find['logo']; ?>" id="imgView" style="height:100px;">
                                <input type="hidden" name="logo" value="<?php echo $find['logo']; ?>"/>
