                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" style="padding-top:7px;"><?php echo $find_merchant['mobile']; ?></div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">价格区间</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="start" value="<?php echo $find['start']; ?>">
                            </div>
                            <div class="col-sm-2" style="padding-top:7px;text-align:center;">至</div>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="end" value="<?php echo $find['end']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">服务费</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="price" value="<?php echo $find['price']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
