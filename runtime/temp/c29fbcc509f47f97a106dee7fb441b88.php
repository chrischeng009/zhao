                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="wangwang" value="<?php echo $find['wangwang']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">店铺网址</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="url" value="<?php echo $find['url']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
