<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"./application/merchant/view/merchantcash/lists.html";i:1586928868;s:64:"/www/wwwroot/nouser/application/merchant/view/common/header.html";i:1586928869;s:62:"/www/wwwroot/nouser/application/merchant/view/common/menu.html";i:1586928869;s:64:"/www/wwwroot/nouser/application/merchant/view/common/footer.html";i:1586928869;s:67:"/www/wwwroot/nouser/application/merchant/view/merchantcash/add.html";i:1586928868;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" style="padding-top:7px;">
                                <?php echo $find_merchant['bankname']; ?>&nbsp;<?php echo $find_merchant['realname']; ?>&nbsp;<?php echo $find_merchant['bankcode']; ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-3">
                                <input type="hidden" name="bankname" value="<?php echo $find_merchant['bankname']; ?>">
                                <input type="hidden" name="realname" value="<?php echo $find_merchant['realname']; ?>">
                                <input type="hidden" name="bankcode" value="<?php echo $find_merchant['bankcode']; ?>">
...
<script type="text/javascript">
    $("#btn2").on('click',function() {
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_check.html',
            dataType:'text',
            data:'',
            success:function(data)
            {
